    ...
    <main className="bg-sky-100/70">
      <div className="mx-auto max-w-[1400px] px-4 py-8 pb-20 sm:px-5 lg:px-6">
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {/* Orders */}
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-blue-deep/10">
          ...
          <Link
            href="/orders"
            className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-brand-orange/30 hover:shadow-lg hover:shadow-brand-blue-deep/10"
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg text-slate-300 transition group-hover:translate-x-1 group-hover:text-brand-orange">
                →
              </span>
            </div>
          ...
          <div className="lg:col-span-2 rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            {currentOrder ? (
              <Link
                ...
                className="group block p-6 transition hover:bg-slate-50/60"
              >
                ...
                <div className="mt-5 flex items-center justify-between border-t border-slate-100 pt-4">
                  ...
                  <span className="text-brand-blue-deep transition-all group-hover:translate-x-1 group-hover:text-brand-orange">
                    →
                  </span>
                </div>
              </Link>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-3">
                ...
                {recentOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <span className="text-xs text-brand-blue-deep transition-colors group-hover:text-brand-orange">
                        →
                      </span>
                    </div>
                  </Link>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              <Link
                href="/services"
                className="group flex items-center justify-between rounded-xl border border-slate-200 p-4 transition hover:-translate-y-0.5 hover:border-brand-orange/30 hover:bg-brand-blue-deep/5 hover:shadow-md"
              >
                <div>
                  <p className="text-sm font-bold text-slate-900">
                    Start an Order
