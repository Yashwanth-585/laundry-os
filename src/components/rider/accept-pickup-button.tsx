...
import { acceptPickupTaskAction } from "@/app/actions/delivery-task";
...
export function AcceptPickupButton({
    ...
    async function handleAccept() {
        ...
        const result = await acceptPickupTaskAction(taskId);

        if (!result.success) {
            setError(result.error ?? "Unable to accept pickup.");
    ...
    return (
        <div>
            ...
            >
                {isSubmitting ? "Accepting..." : "Accept Pickup"}
            </button>
